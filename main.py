...
@app.get("/")
def on_router():
    return Response(json.dumps({"status": 200, "data": {"message": {"vi": "Chào mừng đến với Mc API", "en": "Welcome to Mc API"}, "language": {"vi": "Chỉ hỗ trợ Tiếng Việt", "en": "Only supports Vietnamese"}}}, indent=2), media_type="application/json", status_code=200)
